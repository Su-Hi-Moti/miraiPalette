      ...
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <div className="profile">
            ...
            <span className={`mode-badge ${isDemo ? 'demo' : ''}`}><span className="status-dot" />{isDemo ? 'デモ表示' : '接続中'}</span>
            <span className="avatar">た</span><span className="profile-name">デモ太郎</span>
          </div>
        </div>
      </header>
      {screen === 'chat' ? <div className="learning-workspace">
        <div className="main-column">
          <section className="chat-panel retro-window">
            ...
            <div className="chat-heading">
              <div><p className="section-label">今日のミッション</p><h1>強い橋を作ろう</h1></div>
              <button className="reflection-link" type="button" onClick={() => setScreen('reflection')}>振り返り →</button>
            </div>
